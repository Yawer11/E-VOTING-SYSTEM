...
export default function HomePage() {
  ...
  const { title, heroImage, setVoterDetail, setIsVoterAuth } =
  ...
  const handleSignIn = () => {
    ...
    if (!email || !password) {
      ...
      axios
        .post(`${process.env.REACT_APP_BASE_URL}/voter/signin`, payload)
        .then((res) => {
                ...
                <Stack spacing={10}>
                  ...
                  <Text align={"left"}>
                    <RouterLink to={"adminsignin"}>
                      <Text color={"blue.500"}>Signin As Admin</Text>
                    </RouterLink>
                    <RouterLink to={"admindashboard"}>
                      <Text color={"blue.500"}>Admin Dashboard</Text>
                    </RouterLink>
                  </Text>
                </Stack>
              </Stack>
